...
public class Constants {
    /** cookie信息 **/
    public static final String cookie = "aliyungf_tc=AQAAAKa/VmLpJAkAbtlAcLLc36jJ7ZG0; SESSION=11146315-f5e0-417c-868c-dd6fe030a152";

    /** 加载因子-相当于下平均下来每次都赚 **/
    public static final int factor = new Integer(1);
    ...
    public static final int increaseFactor = new Integer(5);
    ...
    public static final int reversetimes = new Integer(4);
}
